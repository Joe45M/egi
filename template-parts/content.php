...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="container mx-auto mb-32">
            <div class="grid lg:grid-cols-4 gap-14">
                ...
                <div>
                    ...
                    <!--                        <div class="bg-zinc-900 text-white rounded-md p-3">-->
    ...
    <div class="container mx-auto c">
        ...
        <div class="relative mb-3">
            <h3 class="text-3xl font-bold z-50 py-3 pr-5 bg-zinc-900 text-white relative inline-block">Discussion </h3>
    ...
    <div class="container mx-auto">
        ...
        <div class="relative mb-3">
            <h3 class="text-3xl font-bold z-50 py-3 pr-5 bg-zinc-900 text-white relative inline-block">Tags </h3>
            <div class="absolute h-2 bg-brand w-full top-1/2 left-0 z-10 -translate-y-1/2"></div>
        </div>
...
//            ],
    ...
    <div class="container mx-auto">
        ...
        <div class="relative mb-3">
            <h3 class="text-3xl font-bold z-50 py-3 pr-5 bg-zinc-900 text-white relative inline-block">Related </h3>
            <div class="absolute h-2 bg-brand w-full top-1/2 left-0 z-10 -translate-y-1/2"></div>
        </div>
