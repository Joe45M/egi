...
class Nav_Walker extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $data_object, $depth = 0, $args = null, $current_object_id = 0)
    {
        ...
        $item_output .= '<a'.$attributes.' data-test="'.$depth.'">';
        ...
        if ($depth > 0) {
            ...
            $item_output .= '<div class=menu-link-image style=\'background-image: url("'.get_field('menu_background_image', $menu_item).'");\'>';
            $item_output .= '<div class=menu-link-inner>';

            $item_output .= '<span class=\'link-text\'>'.$title.'</span>';
            $item_output .= '<p class="menu-link-description"> '.get_field('menu_description', $menu_item).'</p>';
